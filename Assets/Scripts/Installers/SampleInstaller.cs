...
namespace Installers
{
	public class SampleInstaller : MonoInstaller<SampleInstaller>
	{
		...
		public override void Start()
		{
			...
			var electricityController = Container.Resolve<ElectricityController>();
			...
			gameModel.PlayerModel.Inventory.AddItems(InventoryObjectsTypesEnum.TEST_OBJECT, 10, out edge);
		}
	}
}