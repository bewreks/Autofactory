...
namespace Electricity.Interfaces
{
	public interface IElectricityNet : IDisposable
	{
		...
		public IReadOnlyList<IGeneratorController>          Generators { get; }
		public IReadOnlyList<IElectricalPoleController>     Poles      { get; }
		public IReadOnlyList<IElectricalBuildingController> Buildings  { get; }
